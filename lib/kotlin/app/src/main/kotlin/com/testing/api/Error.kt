...
public class Error( 
  private var errorCode: Long = 0, // required
  ...
  fun setErrorCode(errorCode: Long): Error {
  ...
  fun equals(other: Error?):Boolean {
    ...
    val this_present_errorCode: Boolean = true
    val other_present_errorCode: Boolean = true
  ...
  companion object {
    ...
    private val ERROR_CODE_FIELD_DESC: org.apache.thrift.protocol.TField = org.apache.thrift.protocol.TField("errorCode", org.apache.thrift.protocol.TType.I64, 1.toShort());
    ...
    private val __ERRORCODE_ISSET_ID: Int = 0
