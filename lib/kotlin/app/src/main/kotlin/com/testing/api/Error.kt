...
public class Error( 
...
): org.apache.thrift.TException(),  org.apache.thrift.TBase<Error, Error.Fields>, java.io.Serializable, Cloneable, Comparable<Error> {
  ...
  override fun getFieldValue(field: Fields): Any? {
    return when(field) {
      Fields.ERROR_CODE -> getErrorCode()
      Fields.REASON -> getReason()
    }
  }
  ...
  override fun isSet(field: Fields): Boolean {
    return when (field) {
      Fields.ERROR_CODE->isSetErrorCode()
      Fields.REASON->isSetReason()
    }
  }
  ...
  companion object {
    ...
    private val metaDataMap: Map<Fields, org.apache.thrift.meta_data.FieldMetaData> = mapOf(
      Fields.ERROR_CODE to org.apache.thrift.meta_data.FieldMetaData("errorCode", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, ErrorCodes::class.java)),
      Fields.REASON to org.apache.thrift.meta_data.FieldMetaData("reason", org.apache.thrift.TFieldRequirementType.DEFAULT, 
