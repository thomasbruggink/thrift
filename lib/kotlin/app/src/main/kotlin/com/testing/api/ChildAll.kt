...
public class ChildAll( 
...
): org.apache.thrift.TBase<ChildAll, ChildAll.Fields>, java.io.Serializable, Cloneable, Comparable<ChildAll> {
  ...
  override fun getFieldValue(field: Fields): Any? {
    return when(field) {
      Fields.INNER_VARIABLE -> getInnerVariable()
    }
  }
  ...
  override fun isSet(field: Fields): Boolean {
    return when (field) {
      Fields.INNER_VARIABLE->isSetInnerVariable()
    }
  }
  ...
  companion object {
    ...
    private val metaDataMap: Map<Fields, org.apache.thrift.meta_data.FieldMetaData> = mapOf(
      Fields.INNER_VARIABLE to org.apache.thrift.meta_data.FieldMetaData("innerVariable", org.apache.thrift.TFieldRequirementType.DEFAULT, 
