...
public class HelloAll( 
  ...
  private var combiner: ABCombiner?  = ABCombiner() // required
): org.apache.thrift.TBase<HelloAll, HelloAll.Fields>, java.io.Serializable, Cloneable, Comparable<HelloAll> {
    ...
    companion object {
      ...
      fun findByThriftId(fieldId: Short): Fields? {
        return when(fieldId) {
          ...
          3.toShort() -> // VARIABLE3
            VARIABLE3
          4.toShort() -> // CHILD_NODE
            CHILD_NODE
          5.toShort() -> // LIST_STRING
            LIST_STRING
          6.toShort() -> // MAP_STRING_STRING
            MAP_STRING_STRING
          7.toShort() -> // SET_STRING
            SET_STRING
          8.toShort() -> // BIN_DATA
            BIN_DATA
          9.toShort() -> // COMBINER
  ...
  constructor(other: HelloAll) : this() {
    ...
    if (other.isSetCombiner()) {
      this.combiner = ABCombiner(other.combiner!!)
    }
  }
  ...
  fun getCombiner():ABCombiner? {
    return this.combiner
  }

  fun setCombiner(combiner: ABCombiner?): HelloAll {
  ...
  fun isSetCombiner(): Boolean {
    return this.combiner != null;
  }

  fun setCombinerIsSet(value: Boolean) {
    if (!value) {
      this.combiner = null;
    }
  }
  ...
  override fun setFieldValue(field: Fields,  value: Any?) {
    ...
    Fields.COMBINER ->
      if (value == null) {
        ...
        setCombiner(value as ABCombiner)
      }
  ...
  override fun getFieldValue(field: Fields): Any? {
    return when(field) {
      Fields.VARIABLE1 -> getVariable1()
      Fields.VARIABLE2 -> getVariable2()
      Fields.VARIABLE3 -> getVariable3()
      Fields.CHILD_NODE -> getChildNode()
      Fields.LIST_STRING -> getListString()
      Fields.MAP_STRING_STRING -> getMapStringString()
      Fields.SET_STRING -> getSetString()
      Fields.BIN_DATA -> getBinData()
      Fields.COMBINER -> getCombiner()
    }
  }
  ...
  override fun isSet(field: Fields): Boolean {
    return when (field) {
      Fields.VARIABLE1->isSetVariable1()
      Fields.VARIABLE2->isSetVariable2()
      Fields.VARIABLE3->isSetVariable3()
      Fields.CHILD_NODE->isSetChildNode()
      Fields.LIST_STRING->isSetListString()
      Fields.MAP_STRING_STRING->isSetMapStringString()
      Fields.SET_STRING->isSetSetString()
      Fields.BIN_DATA->isSetBinData()
      Fields.COMBINER->isSetCombiner()
    }
  }
  ...
  fun equals(other: HelloAll?):Boolean {
    ...
    val this_present_combiner: Boolean = true && this.isSetCombiner()
    val other_present_combiner: Boolean = true && other.isSetCombiner()
    if (this_present_combiner || other_present_combiner) {
      if (!(this_present_combiner && other_present_combiner))
        return false;
      if (!this.combiner!!.equals(other.combiner))
        return false;
    }
  ...
  override fun hashCode():Int {
    ...
    hashCode = hashCode * 8191 + (if(isSetCombiner()) 131071 else 524287)
    if (isSetCombiner())
      hashCode = hashCode * 8191 + combiner.hashCode();
  ...
  override fun compareTo(other: HelloAll):Int {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCombiner(), other.isSetCombiner());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCombiner()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.combiner, other.combiner);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private class HelloAllStandardScheme : org.apache.thrift.scheme.StandardScheme<HelloAll>() {
    ...
    override fun read(iprot:org.apache.thrift.protocol.TProtocol, struct:HelloAll) {
      ...
      while (true)
      {
        ...
        when (schemeField.id.toInt()) {
          ...
          9 -> // COMBINER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.combiner = ABCombiner()
              struct.combiner?.read(iprot)
              struct.setCombinerIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
          else ->
    ...
    override fun write(oprot:org.apache.thrift.protocol.TProtocol, struct:HelloAll) {
      ...
      if (struct.combiner != null) {
        oprot.writeFieldBegin(COMBINER_FIELD_DESC)
        struct.combiner?.write(oprot);
        oprot.writeFieldEnd()
      }
  ...
  private class HelloAllTupleScheme : org.apache.thrift.scheme.TupleScheme<HelloAll>() {
    ...
    override fun write(oprot:org.apache.thrift.protocol.TProtocol, struct:HelloAll) {
      ...
      if (struct.isSetCombiner()) {
        optionals.set(8)
      }
      prot.writeBitSet(optionals, 9)
      if (struct.isSetVariable1()) {
        oprot.writeString(struct.Variable1)
      }
      if (struct.isSetVariable2()) {
    ...
    override fun read(iprot: org.apache.thrift.protocol.TProtocol, struct:HelloAll) {
      ...
      val incoming:java.util.BitSet = prot.readBitSet(9)
      if (incoming.get(0)) {
        struct.Variable1 = iprot.readString()
        struct.setVariable1IsSet(true)
      }
  ...
  companion object {
    ...
    private val COMBINER_FIELD_DESC: org.apache.thrift.protocol.TField = org.apache.thrift.protocol.TField("combiner", org.apache.thrift.protocol.TType.STRUCT, 9.toShort());
    ...
    private val metaDataMap: Map<Fields, org.apache.thrift.meta_data.FieldMetaData> = mapOf(
      Fields.VARIABLE1 to org.apache.thrift.meta_data.FieldMetaData("Variable1", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)),
      Fields.VARIABLE2 to org.apache.thrift.meta_data.FieldMetaData("Variable2", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)),
      Fields.VARIABLE3 to org.apache.thrift.meta_data.FieldMetaData("Variable3", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)),
      Fields.CHILD_NODE to org.apache.thrift.meta_data.FieldMetaData("ChildNode", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ChildAll::class.java)),
      Fields.LIST_STRING to org.apache.thrift.meta_data.FieldMetaData("listString", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))),
      Fields.MAP_STRING_STRING to org.apache.thrift.meta_data.FieldMetaData("mapStringString", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
              org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
              org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))),
      Fields.SET_STRING to org.apache.thrift.meta_data.FieldMetaData("setString", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          org.apache.thrift.meta_data.SetMetaData(org.apache.thrift.protocol.TType.SET, 
              org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))),
      Fields.BIN_DATA to org.apache.thrift.meta_data.FieldMetaData("binData", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING          , true)),
      Fields.COMBINER to org.apache.thrift.meta_data.FieldMetaData("combiner", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ABCombiner::class.java)))
    init {
