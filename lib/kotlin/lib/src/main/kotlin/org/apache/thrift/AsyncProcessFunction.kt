...
abstract class AsyncProcessFunction<I, T : TBase<*, *>?>(
    ...
    @Throws(TException::class)
    abstract suspend fun getResult(iface: I, args: T): TBase<*, *>?
    abstract val emptyArgsInstance: T

    companion object {
        private val LOGGER = LoggerFactory.getLogger(AsyncProcessFunction::class.java.name)
    }
}
